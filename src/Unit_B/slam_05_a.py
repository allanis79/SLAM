...
def get_corresponding_points_on_wall(points,
    ...
    for i in points:
	    if i[0] <eps:
	    	left_list.append(i)
	    	right_list.append((arena_left,i[1]))
	    if i[1] <eps:
	    	left_list.append(i)
	    	right_list.append((i[0],arena_bottom))
	    if abs(i[0] - arena_right) < eps:
	    	left_list.append(i)
	      	right_list.append((arena_right,i[1]))
	    if abs(i[1] - arena_top) < eps:
	    	left_list.append(i)
	    	right_list.append((i[0],arena_top))
